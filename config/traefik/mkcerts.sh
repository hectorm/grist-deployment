...

{
	...
	SERVER_CRT="${CERTS_DIR:?}"/server/server.crt
	SERVER_CRT_CNF="${CERTS_DIR:?}"/server/server.cnf
	SERVER_CRT_CA="${CERTS_DIR:?}"/server/ca.crt
	...
	# CLIENT_CSR="${CERTS_DIR:?}"/client/client.csr
	# CLIENT_CRT="${CERTS_DIR:?}"/client/client.crt
	# CLIENT_CRT_CNF="${CERTS_DIR:?}"/client/client.cnf
	# CLIENT_CRT_CA="${CERTS_DIR:?}"/client/ca.crt
	# CLIENT_CRT_FULLCHAIN="${CERTS_DIR:?}"/client/fullchain.crt
	# CLIENT_CRT_SUBJ='/CN=alice'
	# CLIENT_CRT_VALIDITY_DAYS='7300'
	# CLIENT_CRT_RENOVATION_DAYS='30'
	# CLIENT_P12="${CERTS_DIR:?}"/client/client.p12
